...
public class NodeTest {
    ...
    public void handlesBaseUri() {
        ...
        Element noBase = new Element.Builder(tag).baseUri("").attributes(attribs).build();
        ...
        Element withBase = new Element.Builder(tag).baseUri("http://foo/").attributes(attribs).build();
        ...
        Element dodgyBase = new Element.Builder(tag).baseUri("wtf://no-such-protocol/").attributes(attribs).build();
    ...
    public void handleAbsOnLocalhostFileUris() {
        Document doc = Jsoup.parse("<a href='password'>One/a><a href='/var/log/messages'>Two</a>",
                "file://localhost/etc/");
        Element one = doc.select("a").first();
    ...
    public void handlesAbsOnProtocolessAbsoluteUris() {
        ...
        Document doc3 = Jsoup.parse("<img src=//www.google.com/images/errors/logo_sm.gif alt=Google>",
                "https://google.com");
    ...
    public void absHandlesRelativeQuery() {
        Document doc = Jsoup.parse("<a href='?foo'>One</a> <a href='bar.html?foo'>Two</a>",
    ...
    public void root() {
        ...
        Element standAlone = new Element.Builder(Tag.valueOf("p")).baseUri("").build();
    ...
    public void before() {
        ...
        Element newNode = new Element.Builder(Tag.valueOf("em")).baseUri("").build();
    ...
    public void orphanNodeReturnsNullForSiblingElements() {
        Node node = new Element.Builder(Tag.valueOf("p")).baseUri("").build();
        Element el = new Element.Builder(Tag.valueOf("p")).baseUri("").build();
