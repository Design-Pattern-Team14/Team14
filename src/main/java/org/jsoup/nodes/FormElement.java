...
public class FormElement extends Element {
    ...
    public FormElement(Tag tag, String baseUri, Attributes attributes) {
        ...
        super(new Element.Builder(tag).baseUri(baseUri).attributes(attributes));
    }
     ...
     * set up from the form values. You can then set up other options (like
     * user-agent, timeout, cookies), then execute it.
     * 
     * @return a connection prepared from the values of this form.
     * @throws IllegalArgumentException if the form's absolute action URL cannot be
     *                                  determined. Make sure you pass the
    ...
    /**
     * Get the data that this form submits. The returned list is a copy of the data,
     * and changes to the contents of the list will not be reflected in the DOM.
     * 
